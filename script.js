class FormValidation{
    ...
    validateUsername() {
        if (this.formValues.username === "") {
            ...
            this.errorValues.usernameErr = "* Please Enter atleast 8 character"
            this.showErrorMsg(0,this.errorValues.usernameErr)
        } else if (this.formValues.username.length > 17)
         {
            this.errorValues.usernameErr = "*should not exceed morethan 17 character"
            this.showErrorMsg(0,this.errorValues.usernameErr)
        }
        else {
    ...
    validatePhonenumber() {
        ...
        if (this.formValues.phonenumber === "") {
            this.errorValues.phonenumberErr = "* Enter Your Phune Number"
        ...
        this.showSuccessMsg(2)
            ...
            this.errorValues.phonenumberErr = "Ivalid Phune Number"
            this.showErrorMsg(2,this.errorValues.phonenumberErr)
    }
    }
    validatePassword(){
...
document.getElementsByClassName('form')[0].addEventListener('submit', event => {event.preventDefault()
